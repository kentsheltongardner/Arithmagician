...
export const TypeIsTransparent = [
    true,
    false,
    false,
    false,
...
export const StringToTool = {
    ToolBuild: ToolBuild,
    ToolConnect: ToolConnect,
    ToolSelect: ToolSelect,
};
export const ToolToString = [
    'ToolBuild',
    'ToolConnect',
    'ToolSelect',
];
...
export const StringToUnaryOperator = {
    '': UnaryOperatorNone,
...
export const StringToBinaryOperator = {
...
export const StringToBooleanValue = {
