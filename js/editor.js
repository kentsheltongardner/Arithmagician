...
export default class Editor {
    constructor() {
        ...
        this._inspectCell = new Point(C.WorldWidthCells / 2, C.WorldHeightCells / 2);
        this._selectPoint = new Point(0, 0);
        this._selection = new Array(C.WorldWidthCells);
        this._selectionConnections = new Array(C.WorldWidthCells);
        this._world = new World();
        this._copier = new Copier();
        this._memory = new Memory();
        this._broadcastChannel = new BroadcastChannel('arithmagician');
