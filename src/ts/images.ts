...
export const Inspector          = <HTMLImageElement>document.getElementById('inspector-image')
export const Font               = <HTMLImageElement>document.getElementById('font-image')
export const Darkness           = <HTMLImageElement>document.getElementById('darkness-image')
export const Cursor             = <HTMLImageElement>document.getElementById('cursor-image')

export const TypeToTileset      = new Map<number, HTMLImageElement>()

export const ArithmagicianOffset    = new Map<number, number>()
export const EmitterOffset          = new Map<number, number>()
export const ReceiverOffset         = new Map<number, number>()
export const OrthogonalOffset       = new Map<number, number>()
...
export function loadImages() {
    ...
    for (const emitterImage of emitterImages) {
        const image     = <HTMLImageElement>emitterImage
    ...
    for (const receiverImage of receiverImages) {
        const image     = <HTMLImageElement>receiverImage
        const tileset   = createBinaryTileset(image)
        const type      = C.StringToType[<string>image.dataset.type]
        TypeToTileset.set(type, tileset)
    }
    ...
    for (const arithmagicianImage of arithmagicianImages) {
        const image     = <HTMLImageElement>arithmagicianImage
        const type      = C.StringToType[<string>image.dataset.type]
        TypeToTileset.set(type, image)
    }
}