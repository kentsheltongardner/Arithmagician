...
export default class World {
    floor = new Array(C.WorldWidthCells);
    floorConnections = new Array(C.WorldWidthCells);
    objects = new Array(C.WorldWidthCells);
    objectConnections = new Array(C.WorldWidthCells);
    objectValues = new Array(C.WorldWidthCells);
    objectPorts = new Array(C.WorldWidthCells);
    roof = new Array(C.WorldWidthCells);
    roofConnections = new Array(C.WorldWidthCells);
    camera = new Array(C.WorldWidthCells);
    constructor() {
